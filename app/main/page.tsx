      ...
      {!isAuthenticated ? (
        <div className={styles['main-content']}>
          ...
          <nav className={styles['main-links']}>
            <button onClick={() => router.push('/sign-in')} type="button">
              Sign In
            </button>
        ...
        <div className={styles['main-content']}>
          ...
          <nav className={styles['main-links']}>
            <button onClick={() => router.push('/rest-client')} type="button">
              REST Client
            </button>
            <button onClick={() => router.push('/graphiql-client')} type="button">
              GraphiQL Client
            </button>
